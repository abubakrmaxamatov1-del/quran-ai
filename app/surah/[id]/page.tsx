        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            {ayats.map((ayat) => (
              <div 
                key={ayat.id}
                className="group relative rounded-[32px] border border-white/80 bg-white/60 backdrop-blur-lg p-6 shadow-sm transition-all hover:shadow-md"
              >
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-50 text-xs font-bold text-emerald-600 border border-emerald-100">
                    {ayat.number}
                  </div>
                  <div className="flex gap-2">
                    <button className="rounded-full p-2 text-slate-400 hover:bg-emerald-50 hover:text-primary transition-all">
                      <Play size={16} />
                    </button>
                    <button 
                ...
                {selectedAyat?.id === ayat.id && (
                  <div className="mt-6 overflow-hidden rounded-2xl bg-emerald-50/50 p-6">
                    <div className="mb-3 flex items-center gap-2 text-emerald-700">
                      <BookOpen size={18} />
                      <h4 className="font-bold">Tafsir</h4>
                    </div>
                    <div className="prose prose-emerald max-w-none text-zinc-700">
