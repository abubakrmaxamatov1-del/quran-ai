...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white/40 backdrop-blur-xl border-b border-white/50 shadow-sm">
      <div className="container mx-auto flex h-16 items-center justify-between px-4 max-w-[480px]">
        <Link href="/" className="flex shrink-0 items-center justify-center bg-white/70 backdrop-blur-md rounded-2xl border border-white/60 shadow-sm shadow-[0_0_15px_rgba(0,200,83,0.15)] size-[52.8px]">
        ...
        <div className="flex w-12 items-center justify-end">
          <button className="flex size-11 cursor-pointer items-center justify-center overflow-hidden rounded-2xl bg-white/70 backdrop-blur-md text-slate-600 hover:text-emerald-600 transition-colors border border-white/60 shadow-sm">
